...
export function ScriptConfigPanel() {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-dark-900 rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[80vh] overflow-hidden border border-dark-700">
        ...
        <div className="p-6 overflow-y-auto max-h-[60vh]">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-2">
                      ...
                      <input
                        ...
                        className="flex-1 px-3 py-2 border border-dark-600 rounded-md text-sm bg-dark-700 text-white placeholder-gray-400"
                    ...
                    <div className="flex space-x-2">
                      ...
                      <button
                        ...
                        className="px-3 py-1 bg-dark-600 text-gray-300 text-sm rounded-md hover:bg-dark-500"
                      >
                        Cancel
                      </button>
                    </div>
          ...
          <div className="mt-8 p-4 bg-primary-900/20 rounded-lg border border-primary-500/20">
            <h4 className="font-medium text-primary-400 mb-2">Setup Instructions:</h4>
